...
| MK Brokers Bank               | Investment company database breach - 7GB            | https://darkforums.st/Thread-DATABASE-7GB-MK-Brokers-Bank-Bulgaria          |
| SportVision                   | Retail database breach - 1,390,766M records         | https://darkforums.st/Thread-Selling-SportVision-1-390-766M-Bulgaria         |
...
| TransCard Bulgaria          | Payment card system breach                             | https://leakbase.la/threads/transcard-bulgaria.31367/                        |
| iLife.bg                   | E-commerce platform breach                             | https://darkforums.st/Thread-ilife-bg                                     |
| ELD.bg                     | DragonForce ransomware attack                          | http://dragonforxxbp3awc7mzs5dkswrua3znqyx5roefmi4smjrsdi22xwqd.onion/eld.bg/ |
| MKB (en.mkb.bg)             | LockBit ransomware attack on investment company       | http://lockbit7z355oalq4hiy5p7de64l6rsqutwlvydqje56uvevcc57r6qd.onion/en.mkb.bg/ |
...
| National Revenue Agency (NRA) | Major government breach affecting millions             | https://haveibeenpwned.com/Breach/BulgarianNationalRevenueAgency             |
| Videnov.bg                 | Seized from breachforums.st                            | https://breachforums.hn                                                  |
| Toplina                    | Heating company breach                                 | https://breachforums.hn                                                  |
| Alessa.bg                  | E-commerce platform breach                             | https://breachforums.hn                                                  |
| BGTOLL                     | Toll system database breach                            | https://breachforums.hn                                                  |
| Sting AD                   | Hunters International ransomware group attack          | https://huntersinternational.org                                        |
| I&G Brokers                | Insurance brokers data breach                          | https://breachforums.is                                                  |
| Prosecutor's Office (prb.bg)| Government prosecutor's office breach                   | https://darkforums.st                                                    |
| Lev Ins                    | Insurance company breach                               | https://naglite.com                                                     |
| Econt                      | Logistics company data breach                          | https://leakbase.la                                                     |
| Multiple Bulgarian Sites (bezplatno.bg, bg.elmarkstore.eu, brigadiri.com, casioshop.bg, investclub.bg, comfort.bg, bgtime.tv, address.bg, stylewish.bg) | Multiple Bulgarian sites breached | https://predpriemach.com                                                |
| Multiple BreachForums Leaks (A1 Telecom, baumit.bg, kasida.bg, pilini.bg, airelec.bg, bnm.bg, punto.bg, footshop.bg, districtshoes.bg, ecco.bg, myshoes.bg, ardes.bg, andrews.bg, popolo.bg, ebag.bg, mango.bg, dallbogg.bg, ilife.bg) | Broad breach including many organizations | https://breachforums.is                                                |
| Multiple Sites by 'Soni'   | Multiple Bulgarian e-commerce breaches                 | https://breachforums.is                                                |
| A1.bg                      | Telecommunications company breach                      | https://breachforums.is                                                |
| MVR.bg (Ministry of Interior) | Ministry of Interior database breach                   | https://breachforums.is                                                |
| culture-mfa.bg             | Ministry of Culture and Foreign Affairs breach        | https://breachforums.is                                                |
| Multiple Sites by 'crime'  | Multiple Bulgarian breaches                            | https://breachforums.is                                                |
